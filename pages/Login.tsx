        ...
        <div className="w-full lg:w-1/2 bg-gray-900 p-8 lg:p-12 relative flex flex-col justify-between">
          <div>
            ...
            <button
              ...
              disabled={loading}
              type="button"
              className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-900 py-3.5 px-4 rounded-xl font-bold transition-all shadow-md hover:shadow-lg border border-gray-200 active:scale-[0.99]"
            >
