  ...
  return (
    <div className="max-w-2xl mx-auto p-4 py-8">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 flex items-center gap-2">
            <TruckIcon className="w-6 h-6" /> Truck Configuration
        </h1>

        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="mb-6 relative">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Truck Model</label>
                <div 
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Select from popular truck models used in India</p>
            </div>
